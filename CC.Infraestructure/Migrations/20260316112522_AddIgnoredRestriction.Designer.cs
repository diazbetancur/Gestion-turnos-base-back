...
namespace CC.Infrastructure.Migrations
{
    ...
    [Migration("20260316112522_AddIgnoredRestriction")]
    partial class AddIgnoredRestriction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CC.Domain.Entities.IgnoredRestriction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("IgnoredRestrictions", "Management");
                });
            ...
            modelBuilder.Entity("CC.Domain.Entities.ScheduleGap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("GapExplanation")
                        .HasColumnType("text");

                    b.Property<bool>("IsPostAi")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.ToTable("ScheduleGaps", "Management");
                });

            modelBuilder.Entity("CC.Domain.Entities.ScheduleQualityShiftScore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ScheduleQualityShiftScores", "Management");
                });

            modelBuilder.Entity("CC.Domain.Entities.ScheduleSuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AccionesConcretas")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("DiasAfectados")
                        .HasColumnType("jsonb");

                    b.Property<string>("EmpleadosInvolucrados")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<decimal?>("MejoraEstimada")
                        .HasColumnType("numeric(5,2)");
                    ...
                    b.Property<string>("WorkstationsAfectadas")
                        .HasColumnType("jsonb");

                    b.HasKey("Id");

                    b.ToTable("ScheduleSuggestions", "Management");
                });
            ...
            modelBuilder.Entity("CC.Domain.Entities.Signing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("Signings", "Management");
                });

            modelBuilder.Entity("CC.Domain.Entities.SigningCofiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("isAdminMail")
                        .HasColumnType("boolean");

                    b.HasKey("Id");

                    b.ToTable("SigningCofigurations", "Management");
                });
            ...
            modelBuilder.Entity("CC.Domain.Entities.Signing", b =>
                {
                    b.HasOne("CC.Domain.Entities.User", "LastUpdateUser")
                        .WithMany()
